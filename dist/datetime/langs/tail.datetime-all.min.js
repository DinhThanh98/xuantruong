/* pytesNET/tail.select v.0.4.14 | Language Packages | @author SamBrishes, pytesNET <sam@pytes.net> | @license MIT */
!function (i) {
    "function" == typeof define && define.amd ? define(function () {
        return function (e) {
            i(e)
        }
    }) : void 0 !== window.tail && window.tail.DateTime && i(window.tail.DateTime)
}(function (e) {
    return e.strings.register("ar", {
    ...
    }), e.strings.register("de_AT", {
        months: ["Jänner", "Februar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"],
        days: ["Sonntag", "Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag"],
        shorts: ["SO", "MO", "DI", "MI", "DO", "FR", "SA"],
        time: ["Stunden", "Minuten", "Sekunden"],
        header: ["Wähle einen Monat", "Wähle ein Jahr", "Wähle ein Jahrzehnt", "Wähle eine Uhrzeit"]
    }), e.strings.register("el", {
